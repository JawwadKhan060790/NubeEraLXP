...
using NubeEra.Application.Mappings;
using NubeEra.Application.Services;
using NubeEra.Application.Validators;
using NubeEra.Application.Interfaces.Services.Ecommerce;
using NubeEra.Application.Services.Ecommerce;
using NubeEra.Application.Interfaces.Services.SupportTicket;
using NubeEra.Application.Services.SupportTicket;
using NubeEra.Application.Interfaces.Services.Event;
using NubeEra.Application.Services.Event;
using NubeEra.Application.Interfaces.Services.WebsiteRegistrations;
using NubeEra.Application.Services.WebsiteRegistrations;
using NubeEra.Application.Interfaces.Services.AI;
using NubeEra.Application.Services.AI;
using NubeEra.Application.Interfaces.Services.Reporting;
using NubeEra.Application.Services.Reporting;
using NubeEra.Application.Reporting.Providers;
using NubeEra.Application.Interfaces.Services.Certificates;
using NubeEra.Application.Services.Certificates;
using NubeEra.Application.Interfaces.Services.ReportCards;
using NubeEra.Application.Services.ReportCards;

namespace NubeEra.Application;
