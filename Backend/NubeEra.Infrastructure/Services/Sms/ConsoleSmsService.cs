...
using NubeEra.Application.Interfaces.Services.Sms;

namespace NubeEra.Infrastructure.Services.Sms;
...
/// NubeEra.Infrastructure/DependencyInjection.cs from ConsoleSmsService to the new
