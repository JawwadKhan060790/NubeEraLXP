...
public class AuthController : ControllerBase
{
    ...
    private readonly Veriton.Application.Interfaces.Services.Email.IEmailService _emailService;
    ...
    public AuthController(
        ...
        Veriton.Application.Interfaces.Services.Email.IEmailService emailService)
    {
    ...
    public async Task<IActionResult> ForgotPassword(ForgotPasswordRequestDto request)
    {
        ...
        await _emailService.SendAsync(
            user.Email,
            "Your Veriton LMS password reset code",
...
// Request DTOs now live in Veriton.Application/DTOs/Auth/AuthRequestDtos.cs
