...
using Veriton.API.Extensions;
using Veriton.Infrastructure;
using Veriton.Infrastructure.Logging;
...
builder.Services.AddControllers(options =>
    {
        options.Filters.Add<Veriton.API.Filters.ApiResponseFilter>();
    })
...
app.UseVeritonMiddleware();         // Global exception handler
