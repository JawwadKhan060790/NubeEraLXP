...
namespace Veriton.Application.Interfaces.Services.Event;

public interface IEventService
{
    Task<List<object>> GetEventsAsync();
    Task<object?> GetEventByIdAsync(Guid id);
    Task<Veriton.Domain.Entities.Event> CreateEventAsync(CreateEventDto dto);
    Task<Veriton.Domain.Entities.Event> UpdateEventAsync(Guid id, CreateEventDto dto);
