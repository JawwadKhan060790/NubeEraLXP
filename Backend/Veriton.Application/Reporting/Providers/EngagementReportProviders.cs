...
/// <summary>"Learning Progress Reports" — per-student lesson-completion progress against their grade's curriculum, the same metric <see cref="Veriton.Application.Services.ParentService"/> surfaces on the parent dashboard, here exposed as a filterable/exportable report.</summary>
