...
namespace Veriton.Application.Services.AI;
        ...
        AIChatConfig? config)
    {
        ...
        if (provider.Equals("ollama", StringComparison.OrdinalIgnoreCase))
        {
            ...
            var requestBody = new
            {
                ...
                messages = new[]
                {
                    new { role = "system", content = $"You are the Veriton STEM LMS Copilot, a highly intelligent assistant. Here is the verified context and data about the logged-in user:\n{systemContext}" },
            ...
            var requestBody = new
            {
                contents = new[]
                {
                    new
                    {
                        parts = new[]
                        {
                            new { text = $"System Prompt & Database Context:\nYou are the Veriton STEM LMS Copilot, a highly intelligent assistant. Answer the user strictly using these rules and context:\n{systemContext}\n\nUser: {userMessage}" }
                        }
                    }
                },
