...
public class RecycleBinService : IRecycleBinService
{
    ...
    private readonly IGenericRepository<Veriton.Domain.Entities.Event> _events;
    ...
    public RecycleBinService(
        ...
        IGenericRepository<Veriton.Domain.Entities.Event> events,
    ...
    private static async Task ActOn<T>(IGenericRepository<T> repo, Guid id, bool isRestore)
        where T : Veriton.Domain.Common.BaseEntity
    {
