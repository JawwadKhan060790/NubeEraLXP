...
using Veriton.Infrastructure.Persistence.Configurations;
    ...
    public static void Seed(AppDbContext context, IConfiguration configuration)
    {
        ...
        if (defaultSchool == null)
        {
            defaultSchool = new School
            {
                ...
                Name = configuration["Seed:SchoolName"] ?? "Veriton International School",
                IsActive = true
            };
        ...
        var b2cSchool = context.Schools.FirstOrDefault(s => s.SchoolCode == "VERITON-SCHOOL");
        if (b2cSchool == null)
        {
        ...
        string adminEmail = configuration["Seed:AdminEmail"] ?? "superadmin@veriton.com";
        ...
        // 3. Admin Users
        SeedUser(context, "admin1@veriton.com", "Admin@123", AppRoles.Admin, "Admin", "One", defaultSchool.Id);
        
        // 4. Staff User
        SeedUser(context, "staff1@veriton.com", "Staff@123", AppRoles.Staff, "Staff", "One", defaultSchool.Id);
 
        // 5. Principal User
        SeedUser(context, "principal1@veriton.com", "Principal@123", AppRoles.Principal, "Principal", "One", defaultSchool.Id);
        ...
        // 7. Teacher Users
        SeedTeacher(context, "teacher1@veriton.com", "Teacher@123", "TEACH-001", "Teacher", "One", defaultSchool.Id);
 
        // 8. Student Users
        SeedStudent(context, "student1@veriton.com", "Student@123", "STUD-001", "Student", "One", defaultSchool.Id, defaultGrade.Id);
 
        // 9. Parent User
        SeedParent(context, "parent1@veriton.com", "Parent@123", "Parent", "One", "+1234567890", defaultSchool.Id);
