...
using Veriton.Application.Interfaces.Services.Email;

namespace Veriton.Infrastructure.Services.Email;
...
public class SmtpEmailService : IEmailService
{
    ...
    public async Task<bool> SendAsync(string toAddress, string subject, string body, bool isHtml = false)
    {
        ...
        try
        {
            ...
            var fromName = _configuration["Smtp:FromName"] ?? "Veriton LMS";
