...
namespace Veriton.Seeder.Performance;
...
public static class LoadTester
{
    ...
    // Target: pre-seeded user in Veriton_DB_2 (s1@student.sch001.edu / 123456)
    ...
    public static async Task RunAsync(string apiBaseUrl)
    {
        Console.WriteLine();
        Console.WriteLine("╔══════════════════════════════════════════════════════════════════╗");
        Console.WriteLine("║              LOAD TEST REPORT — Veriton API (Veriton_DB_2)      ║");
        Console.WriteLine("╚══════════════════════════════════════════════════════════════════╝");
        Console.WriteLine($"\n  Base URL : {apiBaseUrl}");
        ...
        catch (Exception ex)
        {
            ...
            Console.WriteLine($"    Make sure the API is running at {apiBaseUrl} with Veriton_DB_2 configured.");
            Console.ResetColor();
            return;
        }
