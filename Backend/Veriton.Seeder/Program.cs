// ============================================================================
// Veriton.Seeder  -  Large-Scale Performance Test Data Generator
// Target database : Veriton_DB_2  (NEVER touches the production database)
// Run             : dotnet run --project Veriton.Seeder
// ============================================================================
using System.Diagnostics;
using Veriton.Seeder.Core;
using Veriton.Seeder.Seeders;
using Veriton.Seeder.Validation;
using Veriton.Seeder.Performance;

Console.OutputEncoding = System.Text.Encoding.UTF8;

Banner("VERITON LMS -- PERFORMANCE TEST DATA SEEDER");
Console.WriteLine($"  Target Database  : veriton_db  (existing database)");
...
// -- Connection strings -------------------------------------------------------
// Targets the existing production/dev database (veriton_db)
const string SEED_CONN = "Server=localhost;Port=3306;Database=veriton_db;User=root;Password=root123;" +
...
Console.WriteLine($"  Database            : veriton_db");
