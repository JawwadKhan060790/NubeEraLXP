...
namespace Veriton.Seeder.Validation;
...
public static class RecordValidator
{
    ...
    public static async Task<bool> RunAsync(string connStr)
    {
        Console.WriteLine();
        Console.WriteLine("╔══════════════════════════════════════════════════════════════════╗");
        Console.WriteLine("║              RECORD COUNT VALIDATION — Veriton_DB_2             ║");
        Console.WriteLine("╚══════════════════════════════════════════════════════════════════╝");
        Console.WriteLine();
        ...
        {
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine($"  ✓ ALL {pass} TABLE CHECKS PASSED  — Veriton_DB_2 is fully seeded.");
        }
        else
        {
