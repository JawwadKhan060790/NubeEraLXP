            ...
            {paginated.length === 0 ? (
              ...
              paginated.map(s => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center flex-shrink-0 font-black text-indigo-500 text-sm">
                      {s.section_code}
                    </div>
          ...
          {selectedSection ? (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-2 duration-300">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                {/* Color band */}
                <div className={`h-1.5 w-full ${selectedSection.is_active
